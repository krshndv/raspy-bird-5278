...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/raspy-bird-5278)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/raspy-bird-5278
```

A live public deployment of this template is available at [https://raspy-bird-5278.templates.workers.dev](https://raspy-bird-5278.templates.workers.dev)
